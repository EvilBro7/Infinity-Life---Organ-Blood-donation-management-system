...
Begin VB.Form user_details 
   ...
   Begin VB.CommandButton Command4 
      ...
      Width           =   1935
   End
   Begin MSAdodcLib.Adodc udAdodc1 
      Height          =   330
      Left            =   960
      Top             =   9240
      Visible         =   0   'False
...
rs.Open "select * from user_account", con, adOpenForwardOnly, adLockOptimistic
...
d = MsgBox("Are you sure you want to remove this User?", vbQuestion + vbYesNo, "DELETE?")
If d = vbYes Then
rs.Delete
MsgBox "User Removed Successfully", vbInformation
End If
End Sub
