...
Begin VB.Form request_details 
   ...
   Begin VB.Label Label11 
      BackColor       =   &H00FFFFFF&
      Caption         =   "Total number of Requests : "
      BeginProperty Font 
         Name            =   "Open Sans SemiBold"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Image Image1 
      Height          =   1065
      Left            =   240
      Picture         =   "request_details.frx":0000
      Stretch         =   -1  'True
      Top             =   600
      Width           =   1275
   End
   ...
   End
End
Attribute VB_Name = "request_details"
...
rs.Open "select * from request_details", con, adOpenForwardOnly, adLockOptimistic
...
d = MsgBox("Are you sure you want to remove this Request?", vbQuestion + vbYesNo, "DELETE?")
If d = vbYes Then
rs.Delete
MsgBox "Request Removed Successfully", vbInformation
End If
End Sub
