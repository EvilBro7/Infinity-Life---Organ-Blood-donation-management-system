...
Begin VB.Form organ_details 
   ...
   Begin VB.Image Image1 
      Height          =   1065
      Left            =   240
      Picture         =   "organ_details.frx":0000
      Stretch         =   -1  'True
      Top             =   600
      Width           =   1275
   End
   ...
   End
End
Attribute VB_Name = "organ_details"
...
rs.Open "select * from organ_donors", con, adOpenForwardOnly, adLockOptimistic
